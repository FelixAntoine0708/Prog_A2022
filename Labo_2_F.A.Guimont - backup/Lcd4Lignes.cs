...
namespace Labo_2_F.A.Guimont
{
    ...
    class Lcd4Lignes
    {
        ...
        public Boolean genererAffichage(int iIndexRangee, int iIndexColonne, int iCreditCents, int iRetourCents, int iPrixCents,
                                            Boolean iDistributionEnCours, Boolean iManqueCreditActif, Boolean iAnnulationEnCours, Boolean iQteZeroEnCours, string iFood)
        {
                ...
                (creditPrecedent_ != creditCourant_))
            {
                ...
                switch (etatCourantAffichage)
                {
                    ...
                    case (int)etatAffichage.AttenteConfirmation:
                        ...
                        lignesAffichage_[1] = "Case sélectionnée: " + Convert.ToChar(rangeeSelectionnee_ + 'A') + Convert.ToChar(colonneSelectionnee_ + '0')+"  Item: " + nomItem_;   // modifier nom ici*********
                    ...
                    case (int)etatAffichage.Distribution:
                        lignesAffichage_[0] = "Achat confirmé: " + Convert.ToChar(rangeeSelectionnee_ + 'A') + Convert.ToChar(colonneSelectionnee_ + '0') + "  Item: " + nomItem_; 
                    ...
                    case (int)etatAffichage.QteZero:
                        lignesAffichage_[0] = "CASE VIDE " + " de " + nomItem_; 
                        //valeurDollars = Convert.ToDouble(retourCourant_)/100.0f;
                        //stringDollars = String.Format("{0:0.00}", valeurDollars);
                        //lignesAffichage_[1] = "Retour ($): " + stringDollars;
                        break;
